...
router.post('/send-email', async (req, res) => {
  try {
    ...
    // Crie um transportador Nodemailer
    const transporter = nodemailer.createTransport({
      service: 'gmail',
      auth: {
        user: 'assignmentsagaofficial@gmail.com', // Seu endereço email de gmail
        pass: 'uzgi faop atfx zsqr', // sua senha do gmail
      },
    });

    // defições de opções de email
    const mailOptions = {
